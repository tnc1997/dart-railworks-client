    ...
    return DdsHeader(
      flags: _getHeaderFlags(
          chcTextureGroup.texture.chcTexture.data.chcTextureData.mip.chcImageDxs
              .first.format,
          chcTextureGroup
              .texture.chcTexture.data.chcTextureData.mip.chcImageDxs),
      ...
      depth: null,
      mipMapCount: chcTextureGroup.texture.chcTexture.data.chcTextureData.mip
                  .chcImageDxs.length >
              1
          ? chcTextureGroup
